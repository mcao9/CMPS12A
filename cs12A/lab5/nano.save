...
// mcao9@ucsc.edu
// lab5
// a program that automatically generates a letter
// Error 1 is located on line 125: Because the valid sentence codes are 
// 1 through 5 inclusive, the second portion of the if statement needs to  
// exclude the number 5 by changing the greater than or equal to, 
// to just a greater than.
// Error 2 is located on line 185: Because there is a semicolon after the if
// conditional, the if body is nonexistent, making the bottom line a free
// statement which sets the word as "foggy".
// Error 3 is located on line 166: The extra semicolon makes the line into a
// empty else statement and the line below it, a separate if statement
// and because the modifier code was set to one, one is not equal to 3 which
// prompts the else statement to set the phrase as "ERROR".
